...
void task(void* p_arg) {
    ...
    int exeTime = task_data->TaskExecutionTime - task_data->TaskRemainTime;
    ...
    while (missDeadline == 0) {
        ...
        while (task_data->TaskRemainTime > 0 && missDeadline == 0) {
            ...
            exeTime = task_data->TaskExecutionTime - task_data->TaskRemainTime;

#if PROTOCOL == NPCS
            if (task_data->R1UnLock != 0 && exeTime == task_data->R1Lock) {
                LOG_print(3, "./Output.txt", "%2d  LockResource\ttask(%2d)(%2d)\tR1\n",
                    OSTimeGet(), 
                    task_data->TaskID, 
                    task_data->TaskCount
                );
            ...
            else if (task_data->R2UnLock != 0 && exeTime == task_data->R2Lock) {
                LOG_print(3, "./Output.txt", "%2d  LockResource\ttask(%2d)(%2d)\tR2\n",
                    OSTimeGet(), 
                    task_data->TaskID, 
                    task_data->TaskCount
                );
            ...
            if (task_data->R1UnLock != 0 && exeTime == task_data->R1UnLock) {
                LOG_print(3, "./Output.txt", "%2d  UnlockResource\ttask(%2d)(%2d)\tR1\n",
                    OSTimeGet(), 
                    task_data->TaskID, 
                    task_data->TaskCount
                );
            ...
            else if (task_data->R2UnLock != 0 && exeTime == task_data->R2UnLock) {
                LOG_print(3, "./Output.txt", "%2d  UnlockResource\ttask(%2d)(%2d)\tR2\n",
                    OSTimeGet(), 
                    task_data->TaskID, 
                    task_data->TaskCount
                );
